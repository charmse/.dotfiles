...
Kickstart.nvim is a template for your own configuration.
  ...
  explore Neovim! If you don't know anything about Lua, I recommend taking some time to read through a guide. One possible example: - https://learnxinyminutes.com/docs/lua/ And then you can explore or search through `:help lua-guide` - https://neovim.io/doc/user/lua-guide.html Kickstart Guide: I have left several `:help X` comments throughout the init.lua You should run that command and read that help section for more information.
...
vim.cmd [[
     ...
     sign define DiagnosticSignHint  text=󱤅 texthl=DiagnosticSignHint linehl= numhl=DiagnosticSignHint
]]
